  ...
  return (
    <form onSubmit={handleSubmit(handleChangeInfoAcount)}>
      <div className="tw-max-w-4xl tw-flex tw-items-center tw-h-auto lg:tw-h-screen tw-flex-wrap tw-mx-auto tw-my-32 lg:tw-my-0">
        ...
        <div
          id="profile"
          className="tw-w-full lg:tw-w-3/5 tw-rounded-lg lg:tw-rounded-l-lg lg:tw-rounded-r-none tw-shadow-2xl tw-bg-white tw-opacity-75 tw-mx-6 lg:tw-mx-0"
        >
          <div className="tw-p-4 md:tw-p-12 tw-text-center lg:tw-text-left">
            {/* Image for mobile view*/}
            <div
              className="tw-block lg:tw-hidden tw-rounded-full tw-shadow-xl tw-mx-auto tw--mt-16 tw-h-48 tw-w-48 tw-bg-cover tw-bg-center"
              style={{
                backgroundImage:
            ...
            <div className="tw-mt-6 tw-pb-16 lg:tw-pb-0 tw-w-4/5 lg:tw-w-full tw-mx-auto tw-flex tw-flex-wrap tw-items-center tw-justify-between">
              ...
              >
                <svg
                  className="tw-h-6 tw-fill-current tw-text-gray-600 hover:tw-text-green-700"
                  role="img"
                  viewBox="0 0 24 24"
        ...
        <div className="tw-absolute tw-top-0 tw-right-0 tw-h-12 tw-w-18 tw-p-4">
          <button className="js-change-theme focus:tw-outline-none">🌙</button>
        </div>
      </div>
    </form>
  );
