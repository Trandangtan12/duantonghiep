            ...
            <div className="tw-bg-green-500 tw-h-[12rem]">
                <div className="tw-w-3/4 tw-mx-auto">
                    <div className="tw-text-white">
                        ...
                        <p className="tw-text-xl"><span className=" tw-font-bold">{product.from} - {product.to}</span> | <span>Thời gian khởi hành {product.date}</span> - <span>{product.start_time}</span></p>
                    </div>
                    ...
                    <div className="tw-flex-grow">
                        <div className="tw-rounded-lg tw-bg-white tw-p-3 tw-mb-3">
                            <div className="tw-flex">
                                <img src={product.image} className="tw-w-40 tw-h-28 tw-object-cover" alt="" />
                                <div className="tw-ml-5">
                                    <div className="tw-mb-3 tw-flex tw-justify-bet">
                                        <div>
                                            <h3 className="tw-font-bold">{product.name}</h3>
                                            <p className="tw-text-sm tw-text-gray-500">{product.seats} ghế</p>
                                        </div>
                                    </div>
                                    <div>
                    ...
                    <div className="tw-w-[22rem] tw-sticky tw-top-[1rem]">
                        <div className="tw-rounded-lg tw-bg-white tw-p-3 tw-ml-5">
                           <div className="tw-flex tw-justify-between ">
                               ...
                               <div>
                                   <span className="tw-font-bold tw-text-xl">{product.price}đ</span>
                               </div>
                           </div>
                           <div className="tw-flex tw-pt-12">
                               <button className="tw-w-full tw-p-2 tw-rounded-md tw-bg-gray-500 tw-mr-3 tw-text-white">Lưu vé</button>
                               <button className="tw-w-full tw-p-2 tw-rounded-md tw-bg-red-600 tw-text-white">Thanh toán ngay</button>
                           </div>
                        </div>
                    </div>
                </div>
