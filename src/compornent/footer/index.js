...
const Footer = () => {
  return (
    <div>
  <div className="">
    <footer className="tw-text-gray-600 body-font tw-bg-green-600">
      ...
      <div className="tw-bg-green-700">
        <div className="container tw-mx-auto tw-py-4 tw-px-5 tw-flex tw-flex-wrap tw-flex-col sm:tw-flex-row">
          <p className="tw-text-white tw-text-sm tw-text-center sm:tw-text-left">© 2020 Dev —
            <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="tw-text-gray-400 tw-ml-1" target="_blank">@Developer</a>
          </p>
          <span className="tw-inline-flex sm:tw-ml-auto sm:tw-mt-0 tw-mt-2 tw-justify-center sm:tw-justify-start">
            <a className="tw-text-gray-200">
            ...
            <a className="tw-ml-3 tw-text-gray-200">
              <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="tw-w-5 tw-h-5" viewBox="0 0 24 24">
            ...
            <a className="tw-ml-3 tw-text-gray-200">
              <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={0} className="tw-w-5 tw-h-5" viewBox="0 0 24 24">
