...
const SearchCars = () => {
    ...
    return (
        <div className="tw-bg-white tw-w-full tw-p-5 tw-h-[26rem] tw-rounded-lg tw-shadow-lg tw-mr-5">
        <Tab.Group>
        ...
        tw-translate-y-[-50%] tw-bottom-[-11.6rem] tw-left-[50%] tw-rounded-full">
                    SEARCH
                  </div>
                </div>
              </div></Tab.Panel>
            <Tab.Panel>  <div className="formTiket tw-relative">
                ...
                <div className="tw-flex tw-flex-col ">
                    <div className="tw-w-full tw-py-2">
                      ...
                      <SelectForm placeholder="Chọn địa điểm" className="tw-text-black tw-font-bold" options={provinceFilter} /></div>
                    <div className="tw-w-full tw-py-2">
                      <p className="tw-mb-1 tw-text-gray-400">Điểm đến </p>
                      <SelectForm placeholder="Chọn địa điểm" className="tw-text-black tw-font-bold" options={provinceFilter} /></div>
                    <div className="tw-w-full">
                  ...
                  <div className="tw-flex tw-flex-col tw-justify-center tw-ml-2 tw-items-center tw-h-16 tw-bg-red-800 
        tw-text-white tw-text-xl tw-w-40 tw-font-bold tw-shadow-lg tw-absolute tw-translate-x-[-50%] 
        tw-translate-y-[-50%] tw-bottom-[-7.5rem] tw-left-[50%] tw-rounded-full">
                    SEARCH
                  </div>
                </div>
              </div></Tab.Panel>
